...
describe('ProductRepository', () => {
  ...
  it('should update offline item when netwwork is restored', async ()=>{
    ...
    productService.productForEan.withArgs(offlineProds[0].ean).and.returnValue(of({"data":'{"data": ['+JSON.stringify(cartItems[2].product)+'],"success": 1}',"status":2,"headers":{},"url":""}));
