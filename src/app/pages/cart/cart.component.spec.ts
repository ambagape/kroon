...
describe('CartComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    storageSpy.create.and.returnValue(new Promise((resolve,reject)=> resolve(jasmine.createSpyObj('Storage',['create']))));    
    ...
    barcodeScannerSpy.scan.and.returnValue(new Promise((resolve,reject)=>{resolve({text:'3434',format:"EAN_8", cancelled:false})}));
  ...
  it('should load storage or failover', async ()=>{
